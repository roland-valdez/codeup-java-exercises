...
public class ArraysLec_handout {
    ...
    public static void main(String[] args) {
        ...
        int size  = 4;
        double [] firstArray2 = new double[size];
        firstArray2[0] = 1.5;
        System.out.println(firstArray2[0]);
        System.out.println(firstArray2[1]);
...
//            String [] exoticCars = new String[5];
//            exoticCars[1] = "Bugatti";
//            exoticCars[3] = "Ferrari";
        String [] exoticCars = {"Bugatti", "Ferrari"};
        System.out.println(Arrays.toString(exoticCars).replace("[", "").replace("]", ""));
        //~*~ Iterating Arrays ~*~
        //for + .length:
